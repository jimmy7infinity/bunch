...
const HowToStep3Section: React.FC = () => {
  ...
  return (
    <section className="snap-section howto-step3-section">
      ...
      <div className="howto-step3-content">
        ...
        <h1 className="howto-title yellow-fill-text">JOIN CHATS</h1>
        
        <img src={joinChatsChatroom} alt="Join Chats Chatroom" className="howto-step3-image" />
...
export default HowToStep3Section
