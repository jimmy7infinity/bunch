...
const HowToStep1Section: React.FC = () => {
  ...
  return (
    <section className="snap-section howto-step1-section">
      ...
      <div className="howto-step1-content">
        ...
        <h1 className="howto-title yellow-fill-text">LOGIN WITH X</h1>
        
        <img src={loginXButton} alt="Login with X" className="howto-step1-image" />
...
export default HowToStep1Section
